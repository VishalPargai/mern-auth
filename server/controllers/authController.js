...
export const verifyEmail = async (req, res) => {
  ...
  try {
    ...
    await user.save();
    console.log("Cleared OTP, user verified.");
...
export const sendResetOtp = async (req, res) => {
  ...
  if (!email) {
    return res.json({ success: false, message: "The email Required" });
  }
...
export const resetPassword = async (req, res) => {
  ...
  try {
    ...
    //everything checkout now we have to add new password in the DB
